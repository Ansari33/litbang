        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap pl-0">
                <div class="col-md-12 pr-5 mr-2">
                    ...
                    <span class="nav-text bold ml-5">Surat Rekomendasi - View Data</span>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $data['pengusul'] }}">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Judul Penelitian:</label>
                                        <textarea name="tempat" class="form-control" cols="30" rows="3">{{ $data['judul'] }}</textarea>
                                    </div>

                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Isntitusi:</label>
                                        <textarea name="tempat" class="form-control" cols="30" rows="2">{{ $data['institusi'] }}</textarea>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>email:</label>
