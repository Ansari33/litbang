        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap pl-0">
                <div class="col-md-12 pr-5 mr-2">
                    ...
                    <span class="nav-text bold ml-5">Edit Profil</span>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input name="facebook" class="form-control" value="{{ $data['facebook'] }}" placeholder="Alamat Facebook">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Twitter:</label>
                                        <input name="twitter" class="form-control" value="{{ $data['twitter'] }}" placeholder="alamat twitter">
                                    </div>
                                    <div class="col-lg-6">
                                        <!--begin::Card-->
            ...
            var initUppy2 = function(){
                ...
                uppyDashboard.on('complete',function (f) {
                    $.each(f.successful,function(i,e){
                        logos = { url :e.response.uploadURL,nama :e.name, tipe: e.data.type.split('/')[0] };
                    })
                });
