...
{{--                    <ul class="nav nav-light-primary nav-pills tabs-unlimited" id="menu_tab" role="tablist"></ul>--}}
                    <span class="nav-text bold ml-5">Inovasi - Index</span>
                </div>
            </div>
        </div>
...
{{--                                            </div>--}}
                                            <div class="col-md-8 ml-auto my-md-0">
                                                <div class="d-flex flex-row-reverse">
                                                    <div class="ml-2"><a href="/inovasi-tambah" target="_blank" class="btn btn-light-primary btn-sm"
                                                                         onclick=""><i
                                                                class="flaticon2-plus mr-n1"></i></a></div>
                                                    <div class="ml-2"><a href="javascript:;" id="btn_reload_inovasi" class="btn btn-light-success btn-sm"
                                                                         onclick=""><i
...
@push('js')
    <script>
        ...
        $(function () {
            ...
            indexInovasi = $(`#tbl_inovasi`).DataTable({
                orderCellsTop: true,
                fixedHeader: true,
                "deferRender": true,
                dom: "Btplir",
                ...
                buttons: [
                    $.extend( true, {}, buttonCommon, {
                            ...
                            customize: function(xlsx){
                                ...
                                var j = 3;
                                for (var i = 0; i < indexInovasi.columns().count(); i++){
                                    if( $(indexInovasi.column(i).header()).text() == 'Tanggal' || $(indexInovasi.column(i).header()).text() == 'Tanggal Jurnal' || $(indexInovasi.column(i).header()).text() == 'Tanggal Pembayaran'){
                                        var test1 = $(indexInovasi.column(i).data()).toArray();
                                        test1.forEach(test);
                                        function test(item) {
        ...
        $('#btn_reload_inovasi').on('click',function (e) {
               indexInovasi.ajax.reload();
        })
    </script>
@endpush
