        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap pl-0">
                <div class="col-md-12 pr-5 mr-2">
                    ...
                    <span class="nav-text bold ml-5">Surat Masuk - Tambah Data</span>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group date" id="tanggal_pengiriman_pesanan_add" data-target-input="nearest">
                                            <input name="tanggal_penerimaan" onkeydown="return false" type="text" class="form-control datetimepicker-input" placeholder="Pilih Tanggal" data-target="#tanggal_pengiriman_pesanan_add" value="{{ \Carbon\Carbon::now()->format('d-m-Y') }}"/>
                                            <div class="input-group-append" data-target="#tanggal_pengiriman_pesanan_add" data-toggle="datetimepicker">
                                                <span class="input-group-text"><i class="ki ki-calendar"></i></span>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        ...
                                        <textarea name="isi_disposisi" class="form-control" cols="30" rows="4"></textarea>
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Disposisi Kepada:</label>
                                        <textarea name="disposisi_kepada" class="form-control" cols="30" rows="4"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-6">
...
{{--                                            <textarea class="summernote" id="kt_summernote_1" name="surat_Masuk"></textarea>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                            </div>
