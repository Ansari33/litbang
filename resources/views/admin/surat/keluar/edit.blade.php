        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap pl-0">
                <div class="col-md-12 pr-5 mr-2">
                    ...
                    <span class="nav-text bold ml-5">Surat Keluar - Edit Data</span>
                </div>
            </div>
        </div>
                        ...
                        <form id="form_edit_usulan_penelitian">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Nomor:</label><input name="nomor_urut" type="text" class="form-control" placeholder="Nomor" value="{{ $data['id'] }}" />
        ...
        var KTUppy = function () {
            ...
            var initUppy1 = function(){
                ...
                uppyDashboard.addFile({
                    ...
                    data: $('#filesurat').prop('file'), // file blob
                    meta: {
